            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    // #5 update "searching" message to show countdown 
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {characteristic} {icon} {searchCounter}");
                                Thread.Sleep(250);
                            }
                    ...
                    if (noMatchesDog is false)
                    {
                        if(ourAnimals[i, 3] == matchDogs[i])
                        {
                            Console.WriteLine($"{matchDogs[i]} ({ourAnimals[i, 0]})");
